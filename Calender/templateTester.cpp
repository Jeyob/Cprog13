...
CxxTest::StaticSuiteDescription suiteDescription_TemplateTestSuite( "testSuite_Julian.cpp", 25, "TemplateTestSuite", suite_TemplateTestSuite, Tests_TemplateTestSuite );

static class TestDescription_suite_TemplateTestSuite_test_year : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_TemplateTestSuite_test_year() : CxxTest::RealTestDescription( Tests_TemplateTestSuite, suiteDescription_TemplateTestSuite, 30, "test_year" ) {}
...
public:
 TestDescription_suite_TemplateTestSuite_test_month() : CxxTest::RealTestDescription( Tests_TemplateTestSuite, suiteDescription_TemplateTestSuite, 34, "test_month" ) {}
...
public:
 TestDescription_suite_TemplateTestSuite_test_day() : CxxTest::RealTestDescription( Tests_TemplateTestSuite, suiteDescription_TemplateTestSuite, 38, "test_day" ) {}
...
public:
 TestDescription_suite_TemplateTestSuite_test_calendar_to_JD() : CxxTest::RealTestDescription( Tests_TemplateTestSuite, suiteDescription_TemplateTestSuite, 42, "test_calendar_to_JD" ) {}
...
public:
 TestDescription_suite_TemplateTestSuite_test_mod_julian_day() : CxxTest::RealTestDescription( Tests_TemplateTestSuite, suiteDescription_TemplateTestSuite, 47, "test_mod_julian_day" ) {}
...
public:
 TestDescription_suite_TemplateTestSuite_test_MJD() : CxxTest::RealTestDescription( Tests_TemplateTestSuite, suiteDescription_TemplateTestSuite, 91, "test_MJD" ) {}
